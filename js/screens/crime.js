...
function formatResult(result, kind) {
    ...
    const woundText = result.victim_wounded ? `<div class="profile-dim">Жертва ещё и ранена.</div>` : "";
    return `<div class="profile-row" style="color:#7ee787;font-size:18px">💰 Добыча: <b>${result.loot.toFixed(2)}₭</b></div>${itemText}${vorText}${woundText}${identityText}`;
}
